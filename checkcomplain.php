...
$sql = "SELECT * FROM staff_login where STID = '$id'";
...
$sql = "SELECT * FROM user_complain where place = '$place' AND CType = '$dept'";
$result = $conn->query($sql);
...
<tr>
  ...
  <td><a href="solution.php?CID=<?php echo $CID;?>" class="btn btn-info btn-sm" role="button">Update</a>
